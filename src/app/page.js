export default async function Home() {
  return (
    <div className='w-full h-screen flex justify-center items-center'>
      ...
      {/* <div classNameName="grid grid-cols-3 gap-[20px]">
        {blog?.map((data, idx) => (
          <div key={idx} classNameName="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <img classNameName="rounded-t-lg" src={data.cover} alt="image" />

            <div classNameName="p-5">
              <h5 classNameName="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{data.Titulo}</h5>
              <p classNameName="mb-3 font-normal text-gray-700 dark:text-gray-400">{data.description[0].children[0].text}</p>
              <p>{data.platformNames[0]}</p>
            </div>
          </div>
        ))}
      </div> */}
